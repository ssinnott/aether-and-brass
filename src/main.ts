...
import { VIEW_W, VIEW_H, DIFFICULTIES } from './constants.ts';
...
import { TrainingScreen } from './game/screens/training.ts';
import { IntroScreen } from './game/screens/intro.ts';
import { PauseScreen } from './game/screens/pause.ts';
import { TrainPauseScreen } from './game/screens/trainpause.ts';
import { TrialsScreen } from './game/screens/trialsScreen.ts';
import { MovesScreen } from './game/screens/moves.ts';
import { HelpScreen } from './game/screens/help.ts';
import { OptionsScreen } from './game/screens/options.ts';
...
import { options as userOptions } from './game/options.ts';
