...
import {
  drawPole, drawShovel, drawStave, drawCane, drawTongs, drawTaper, drawCartHook, drawBucket, drawCrook, drawLedger,
  drawKiln, drawHose, drawBandolier, drawBullseye, drawCart, drawSatchel, drawYoke,
} from './chandlerKit.ts';
import { pathPoly, paint } from '../../lib/art/shapes.ts';
import { floatText } from '../../art/fx.ts';
import { rad, clamp, sign } from '../../lib/engine/math.ts';
