...
} from './stormcrowRig.ts';
import { CROW_PARTS } from './stormcrowKit.ts';
import { celRect, celBall, celPoly, celCapsule, tones, rimTop, flat, band } from '../../lib/art/shading.ts';
import { getChain } from '../../lib/art/secondary.ts';
import { pathPoly, paint, circle } from '../../lib/art/shapes.ts';
