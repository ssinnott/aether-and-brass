...
import { registerModArt } from '../../game/traits.ts';
import { drawBladder } from './gleaningRig.ts';
import { CH } from './chandlerRig.ts';
import { celBall, celRect, tones } from '../../lib/art/shading.ts';
