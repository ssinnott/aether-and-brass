...
import { celRect, celBall, celPoly, celPath, celCapsule, tones, band, outlinePath } from '../../lib/art/shading.ts';
...
import { flat as flatFill, rimTop as gobRim, band as gobBand } from '../../lib/art/shading.ts';
import { farShade } from '../../art/palettes.ts';
import { getChain as gobChain } from '../../lib/art/secondary.ts';
import { rad as gobRad } from '../../lib/engine/math.ts';
