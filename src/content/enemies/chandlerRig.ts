...
import { celRect, celBall, celPoly, celCapsule, celTaper, tones, rimTop, band, wantSh } from '../../lib/art/shading.ts';
import { drawFist, drawBoot, drawSkull, drawFace, limbRadii } from '../../lib/art/rigParts.ts';
