...
import { CROW_PARTS, drawBoardingAxe, IRON } from './stormcrowKit.ts';
import { frontBox, areaBox } from './common.ts';
import { celRect, celBall, celPoly, celCapsule, tones, rimTop, band } from '../../lib/art/shading.ts';
import { pathPoly, paint, circle, capsule } from '../../lib/art/shapes.ts';
