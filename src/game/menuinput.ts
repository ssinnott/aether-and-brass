...
import { bindings } from '../engine/input.ts';

/** The engine/input.js singleton (screens reach it as `this.game.input`). @typedef {typeof import('../engine/input.ts').input} Input */
