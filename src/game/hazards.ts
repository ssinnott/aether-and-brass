...
import { FLOOR_TOP, TEAM, VIEW_W, ST } from '../constants.ts';
import { Entity } from './entity.ts';
/** @typedef {import('./zones.ts').Zone} Zone */  // solidAt/solidBetween return one; a type-only reference, so no cycle.
...
import { rrect, circle, pathPoly, line } from '../lib/art/shapes.ts';
