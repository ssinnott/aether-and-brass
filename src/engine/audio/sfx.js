...
export const SFX_DEFS = {
  ...
  rank_stamp: (c, d, t, o) => { const e = echo(c, d, { time: 0.06, wet: 0.3, when: t, life: 0.2 }); osc(c, e, t, { type: 'sine', f0: 110 * o.p, f1: 40 * o.p, dur: 0.16, vol: 0.55 * o.v, attack: 0.002 }); noise(c, e, t, { dur: 0.06, vol: 0.45 * o.v, type: 'bandpass', f0: 800 * o.p, f1: 300 * o.p, q: 1, attack: 0.001 }); return clank(c, e, t, { v: o.v, p: o.p, f: 220, mod: 1300, dur: 0.14, vol: 0.2, tick: 0 }); },
  ...
  stage_clear: (c, d, t, o) => { // motif fanfare D F A C D with square triads
    const e = echo(c, d, { time: 0.11, wet: 0.25, taps: 2, when: t, life: 1.0 });
  ...
  cannon: (c, d, t, o) => { const e = echo(c, d, { time: 0.08, wet: 0.3, lowpass: 1200, when: t, life: 0.35 }); return boom(c, e, t, { v: o.v, p: o.p, f0: 80, f1: 25, dur: 0.35, lp: 200, vol: 0.6 }); },
