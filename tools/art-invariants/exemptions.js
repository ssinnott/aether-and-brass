...
export const EXEMPTIONS = [
  ...
  { rule: 'geom/far-palette-leak', subject: 'sootborn:hulk', reason: '2026-09-07: pre-existing leak, src/content/enemies/common.ts gobHand paints the GOB.iron wrist chains from the module constant on both sides (3 colours x 79 keyframes) - farTone the chain links; NOT a licence to weaken the rule' },
  { rule: 'geom/far-palette-leak', subject: 'boss:vane#2', reason: '2026-09-07: pre-existing leak, src/content/enemies/boss.ts vaneHand paints the 3x3 BLADE knuckle glint on the FAR fist from the module constant (88 keyframes) - use tones(rig, inf.pal.metal).hi' },
  ...
  // (src/content/enemies/chandlerRig.ts). Both are measured, both are argued here, and neither is a rig defect:
  //
