...
- **Setting:** the cart road up to the works, white with spilled lime, empty of traffic all the way down it — the
  wagon trains are the ones you meet at its foot (section 2) — and the works' four chimneys drawing smoke straight
  up ahead of you.
