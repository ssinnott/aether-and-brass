...
Global: Escape pauses/unpauses, M mutes, F1 debug overlay. Any free slot joins by pressing its own key or pad button at any time (drop-in). Gamepads claim the lowest free slot on their first button press (never index-bound); P3/P4 have no keyboard block.
