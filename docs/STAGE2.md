...
- **The opening beat (issue #25):** the board does not open on a title card. The party steps off the mooring ladder
  and walks the spine for eleven seconds with nothing to fight and nobody staged in it, while the storm front comes
  over: the board's name is on the **nameplate bolted to the rail** (`NINTH WING - NO BOARDING`) rather than on a
  plate in the middle of the screen, a second plate further along says where the handrail stops, and the thunder
  lands under the last caption. The player has control throughout — the wave director is held, nothing else is — and
  the letterbox marks the beat's start and end. The stinger under the section plate is *nothing up here is bolted to
  the ground*.
